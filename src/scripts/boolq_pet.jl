...
pet_train_cnf = TrainConfig(weight_decay=0.01,learning_rate=1e-5, num_train_epochs=3,batch_size=4,gradient_accumulation_steps=4, temperature=2, max_steps=0)
...
train_pet(
    ...
    pattern_ids=[], 
    output_dir="outputs/boolq/boolq_pet",
