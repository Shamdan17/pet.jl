...
# Use entire set
trnset = BoolQ.(readlines("../data/SuperGLUE/BoolQ/train.jsonl"));
...
pet_train_cnf = TrainConfig(weight_decay=0.01,learning_rate=1e-5, num_train_epochs=3,batch_size=4,gradient_accumulation_steps=4, temperature=2, max_steps=5000)
...
train_pet(
    ...
    ensemble_repetitions=1, final_repetitions=1,
