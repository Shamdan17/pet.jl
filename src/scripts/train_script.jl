...
sc_train_cnf = TrainConfig(weight_decay=0.01,learning_rate=1e-5, use_logits=true, num_train_epochs=1, max_steps=5000,gradient_accumulation_steps=4, temperature=2, batch_size=4)
...
train_pet(
    ...
    pattern_ids=[2, 3, 4, 5, 6], 
    output_dir="outputs/boolq/fullrepproperbias",
