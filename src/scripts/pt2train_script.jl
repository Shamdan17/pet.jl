...
sc_train_cnf = TrainConfig(weight_decay=0.01, use_logits=true, num_train_epochs=1, max_steps=5000,gradient_accumulation_steps=2, temperature=2, batch_size=8)
...
train_pet(
    ...
    pattern_ids=[4, 5, 6], 
    output_dir="pt2minirep",
    ensemble_repetitions=3, final_repetitions=2,
